...
<div id="main" class="main">
    ...
    <div class="job-list">
        <?php if(is_array($newJob)): $i = 0; $__LIST__ = $newJob;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item fl">
            <a href="<?php echo U('Portal/Jobs/detail');?>&id=<?php echo ($vo["id"]); ?>">
                <div class="item-body">
                    <ul>
...
<div id="footer" class="footer">
    <div class="fmain autow">
        <div class="f-nav">
            <ul class="flul">
                <li><a href="<?php echo ($site_host); echo U('portal/page/index');?>&id=20">关于我们</a></li>
                <li><a href="<?php echo ($site_host); echo U('portal/list/index');?>&id=7">帮助中心</a></li>
                <li><a href="<?php echo ($site_host); echo U('portal/page/index');?>&id=22">联系我们</a></li>
                <li><a href="<?php echo ($site_host); echo U('portal/page/index');?>&id=21">加入我们</a></li>
            </ul>
        </div>
        <div class="c"></div>
