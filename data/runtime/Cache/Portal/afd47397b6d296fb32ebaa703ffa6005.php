...
<div id="main" class="main">
    ...
    <div class="job-list">
        <?php if(is_array($ejob)): $i = 0; $__LIST__ = $ejob;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Portal/Jobs/detail');?>&id=<?php echo ($vo["id"]); ?>">
        <div class="item fl">
            <div class="item-body">
                <ul>
    ...
    <div class="job-list">
        <?php if(is_array($hjob)): $i = 0; $__LIST__ = $hjob;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Portal/Jobs/detail');?>&id=<?php echo ($vo["id"]); ?>">
            <div class="item fl">
                <div class="item-body">
                    <ul>
                        <li>岗位名称：<?php echo ($vo["job_name"]); ?></li>
