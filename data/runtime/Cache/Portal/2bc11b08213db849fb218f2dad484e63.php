      ...
      <table width="100%">
        ...
        <tr>
          <td>
			...
			<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','', 1);return false;">
        ...
        <tr>
          <td>
              <span class="switch_list cc">
			<label><input type="radio" name="post[istop]" value="1" ><span>置顶</span></label>
			<label><input type="radio" name="post[istop]" value="0" checked><span>未置顶</span></label>
		 	</span>
		 </td>
        </tr>
        <tr>
          <td>
          	<span class="switch_list cc">
			<label><input type="radio" name="post[recommended]" value="1" ><span>推荐</span></label>
			<label><input type="radio" name="post[recommended]" value="0" checked><span>未推荐</span></label>
		 	</span>
		 </td>
        </tr>
      </table>
    ...
    <div class="table_full">
      <table width="100%" cellpadding="2" cellspacing="2">
            <tr>
              <th width="80">栏目</th>
              <td>
				<?php if(is_array($terms)): foreach($terms as $key=>$vo): ?><label class="checkbox inline">
					  <input type="checkbox" value="<?php echo ($vo["term_id"]); ?>" name="term[]"> <?php echo ($vo["name"]); ?>
