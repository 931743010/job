    ...
    <div id="main" class="main">
        ...
        <div id="job">
            <div class="detail">
                    ...
                    <div class="user fl">
                        ...
                        <div class="user-avatar fl">
                            ...
                            <div class="avatar-img">
                                <?php if($user.avatar_small): ?><img src="<?php echo ($user["avatar_small"]); ?>" alt=""/>
                                    <?php else: ?>
                                    <img src="/tpl/v1/Public/images/logo.png" alt=""/><?php endif; ?>
                ...
                <!--工作内容end-->
                <!--地图开始-->
                <div class="baiduMap" id="allmap" style="width: 980px;height: 500px;">
                        
                </div>
                <div class="mylocation">
                    <label>您的位置: </label><input type="text" name="mylocation" id="mylocation"/>
...
<script>
    ...
    $(".apply-btn").click(function () {
        if(!uid){
            ...
            if(resumeCount>0){
                window.location.href="<?php echo U('Portal/jobs/apply');?>&"+"id=<?php echo ($_GET['id']); ?>";
            }else{
                //去新增简历
                alert("您还没有简历，请先新建简历");
